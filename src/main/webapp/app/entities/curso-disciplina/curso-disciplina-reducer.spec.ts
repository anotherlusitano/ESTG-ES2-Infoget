...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURSODISCIPLINA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CURSODISCIPLINA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CURSODISCIPLINA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CURSODISCIPLINA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CURSODISCIPLINA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CURSODISCIPLINA actions', async () => {
      const arg = 42666;
