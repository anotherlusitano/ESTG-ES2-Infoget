...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFESSORES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFESSORES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFESSORES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROFESSORES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROFESSORES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROFESSORES actions', async () => {
      const arg = 42666;
