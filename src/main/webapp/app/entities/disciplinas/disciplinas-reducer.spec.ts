...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISCIPLINAS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISCIPLINAS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISCIPLINAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DISCIPLINAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DISCIPLINAS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISCIPLINAS actions', async () => {
      const arg = 42666;
