...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './cursos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURSOS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CURSOS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CURSOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CURSOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CURSOS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CURSOS actions', async () => {
      const arg = 42666;
