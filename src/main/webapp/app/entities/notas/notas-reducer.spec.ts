...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './notas.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTAS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTAS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTAS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTAS actions', async () => {
      const arg = 42666;
