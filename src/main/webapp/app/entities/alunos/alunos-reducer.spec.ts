...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './alunos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALUNOS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ALUNOS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ALUNOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ALUNOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ALUNOS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ALUNOS actions', async () => {
      const arg = 42666;
