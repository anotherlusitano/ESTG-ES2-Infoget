...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECRETARIOS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SECRETARIOS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SECRETARIOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SECRETARIOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SECRETARIOS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SECRETARIOS actions', async () => {
      const arg = 42666;
